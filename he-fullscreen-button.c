 ...
 *
 * If the user clicks the button, the #HeFullscreenButton::clicked signal is
 * emitted. If you did not provide a signal handler for the
 * #HeFullscreenButton::clicked signal, then the
 * default handler will call gtk_window_unfullscreen() on the parent window.
 ...
 * @self: A HeFullscreenButton instance.
 *
 ...
 * if you have not set the #HeFullscreenButton:act-on-state-change property to
 * %FALSE.
 */
void
...
/*
 * Everytime the button is clicked, we emit the "clicked" signal.
 */
static gboolean
 ...
 * @parent_window: A GtkWindow instance.
 *
 ...
 * changes to fullscreen and vice versa. Change the #HeFullscreenButton:act-on-state-change
 ...
 * @self: An instance of #HeFullscreenButton
 *
...
he_fullscreen_button_class_init (HeFullscreenButtonClass *klass)
{
	 ...
	 * @button: The #HeFullscreenButton that was clicked
	 *
